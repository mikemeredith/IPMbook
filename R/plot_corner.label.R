...
# Patched version of plotrix::corner.label by Ben Bolker

# The one in the plotrix package does not pass the dots argument to 'text'

corner.label <- function (label = NULL, x = -1, y = 1, xoff = NA, yoff = NA,
    figcorner = FALSE, ...)
{
    if (is.na(xoff))
        xoff <- strwidth("m")/2
